...
with col1:
    user_input['HOUR_APPR_PROCESS_START'] = st.slider("🕒 Hour of Application", 0, 23, 12)
...
with col2:
    user_input['REGION_POPULATION_RELATIVE'] = st.number_input("🏘️ Region Population Relative", min_value=0.0, max_value=1.0, step=0.01)
    ...
    user_input['DAYS_BIRTH'] = st.number_input("🎂 Days Since Birth (negative)", min_value=-30000, max_value=-5000, step=100)
